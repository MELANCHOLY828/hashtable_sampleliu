...
class NeRFSystem(LightningModule):    
    def __init__(self, args):
        ...
        self.model_HashSiren = HashSiren2(hash_mod = True,
        ...
        self.models = [self.model_HashSiren, self.model_MLP_dir]
    ...
    def configure_optimizers(self):
        ...
        # self.optimizer = torch.optim.Adam(list(self.models[0].parameters()), lr=self.args.lr_NeRF, 
